...
const swatches = [
    ...
    {
        name: 'Muted foreground — Grijsblauw',
    ...
    <div class="min-h-screen bg-background text-foreground">
        <header class="border-b border-border bg-card">
            <div class="container mx-auto px-6 py-10">
                ...
                <h1
                    class="mt-2 font-display text-4xl font-semibold text-primary"
                >
                    autoinvoeren<span class="text-accent">spanje</span>.nl —
                    styleguide
                </h1>
                <p class="mt-3 max-w-2xl text-muted-foreground">
                    Tokens, typografie en componenten die op de site gebruikt
                    worden. Alleen zichtbaar in
        ...
        <div class="container mx-auto space-y-16 px-6 py-12">
            ...
            <section>
                ...
                <p class="mt-1 text-sm text-muted-foreground">
                    Tokens worden via CSS variabelen geleverd; gebruik Tailwind
                    utilities zoals
            ...
            <section>
                ...
                <p class="mt-1 text-sm text-muted-foreground">
                    Display: Fraunces (variable serif). Body / UI: Inter
                    (variable sans). Beide via Bunny Fonts.
                </p>
                <div
                    class="mt-6 space-y-6 rounded-2xl border border-border bg-card p-8"
                >
                    <div>
                        <h1
                            class="font-display text-6xl font-semibold text-foreground"
                        >
                            H1 — Fraunces 600
                        </h1>
                        <p class="mt-1 text-xs text-muted-foreground">
                            48–64px · gebruikt voor hero-koppen
                        </p>
                    </div>
                    <div>
                        <h2
                        ...
                        <p class="mt-1 text-xs text-muted-foreground">
                            32–40px · sectiekoppen
                        </p>
                    </div>
                    <div>
                        <h3
                            class="font-display text-2xl font-medium text-foreground"
                        >
                            H3 — Fraunces 500
                        </h3>
                        <p class="mt-1 text-xs text-muted-foreground">
                    ...
                    <div>
                        <p class="text-base text-foreground">
                            Body — Inter 400, 16px. De RDW levert geen
                            BPM-bedrag — dat berekenen we zelf op basis van CO₂,
                            brandstof en datum eerste toelating, met
                            afschrijving naar leeftijd. Een indicatie, geen
                            bindende offerte.
                        </p>
                        <p class="mt-1 text-xs text-muted-foreground">
                            16–18px · standaard body tekst
                        </p>
                    </div>
                    <div>
            ...
            <section>
                ...
                <div
                    class="mt-6 grid gap-6 rounded-2xl border border-border bg-card p-8"
                >
            ...
            <section>
                ...
                <div
                    class="mt-6 flex flex-wrap items-center gap-2 rounded-2xl border border-border bg-card p-8"
                >
                    <Badge>Primair</Badge>
                    ...
                    <Badge class="bg-success text-success-foreground"
                        >Succes</Badge
                    >
                    <Badge class="bg-warning text-warning-foreground"
                        >Waarschuwing</Badge
                    >
                </div>
            </section>
            ...
            <section>
                ...
                <div
                    class="mt-6 grid gap-6 rounded-2xl border border-border bg-card p-8 md:grid-cols-2"
                >
                    <div class="space-y-2">
                        <Label for="kenteken">Kenteken</Label>
                        <Input
                            id="kenteken"
                            v-model="kentekenInput"
                            placeholder="bv. 12-ABC-3"
                        />
                        <p class="text-xs text-muted-foreground">
                            Hint: streepjes zijn optioneel.
                        </p>
                    </div>
                    <div class="space-y-2">
                    ...
                    <div class="space-y-2">
                        <Label for="error" class="text-destructive"
                            >Kenteken — met fout</Label
                        >
                        <Input
                            id="error"
                            v-model="errorInput"
            ...
            <section>
                ...
                <div class="mt-6 space-y-4">
                    <Alert>
                        ...
                        <AlertDescription>
                            BPM-bedragen zijn een indicatie en kunnen afwijken
                            van het uiteindelijke besluit van de
                            Belastingdienst.
                        </AlertDescription>
                    </Alert>
                    <Alert
                        class="border-success/30 text-success [&>svg]:text-success"
                    >
                        <CheckCircle2 />
                        <AlertTitle>Succes</AlertTitle>
                        <AlertDescription class="text-success/90">
                            Je dossier is aangemaakt. We sturen je binnen 24 uur
                            een bevestiging.
                        </AlertDescription>
                    </Alert>
                    <Alert
                        class="border-warning/40 text-warning-foreground [&>svg]:text-warning"
                    >
                        <AlertTriangle />
                        <AlertTitle>Let op</AlertTitle>
                        <AlertDescription>
                            We missen nog je NIE-nummer — upload deze om verder
                            te kunnen.
                        </AlertDescription>
                    </Alert>
                    <Alert variant="destructive">
                        ...
                        <AlertDescription>
                            Het opgegeven kenteken kon niet worden gevonden bij
                            de RDW.
                        </AlertDescription>
                    </Alert>
                </div>
                ...
                <div class="mt-6 grid gap-6 md:grid-cols-2">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription
                                >Opgehaald via de RDW open-data
                                API</CardDescription
                            >
                        </CardHeader>
                    ...
                    <Card class="bg-primary text-primary-foreground">
                        <CardHeader>
                            <CardTitle class="text-primary-foreground"
                                >BPM-indicatie</CardTitle
                            >
                        ...
                        <CardContent>
                            <div
                                class="font-display text-5xl font-semibold text-accent"
                            >
                                € 2.840
                            </div>
                            <p class="mt-2 text-sm text-primary-foreground/70">
                                Geschatte teruggave bij export naar Spanje.
                                Indicatief; geen rechten te ontlenen.
                            </p>
                        </CardContent>
                        <CardFooter>
                            <Button
            ...
            <section>
                ...
                <div class="mt-6 grid gap-4 sm:grid-cols-3 lg:grid-cols-5">
                    <div
                        ...
                        :key="r"
                        :class="[
                            'flex h-24 items-center justify-center border border-border bg-card text-xs text-muted-foreground shadow-sm',
                            r,
                        ]"
                    >
                        {{ r }}
                ...
                <div class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div
                        ...
                        :key="s"
                        :class="[
                            'flex h-24 items-center justify-center rounded-xl border border-border bg-card text-xs text-muted-foreground',
                            s,
                        ]"
                    >
                        {{ s }}
