...
const categories: FaqCategory[] = [
    {
        ...
        items: [
            ...
            {
                question: 'Hoe lang duurt het hele importproces?',
                answer: 'Reken op gemiddeld vier tot acht weken vanaf de exportmelding bij de RDW tot het ontvangen van het definitieve Spaanse kentekenbewijs. De ITV-planning en de administratieve verwerking bij de DGT bepalen grotendeels de doorlooptijd. Wij houden u via uw persoonlijk klantenportaal doorlopend op de hoogte.',
            },
            {
                question: 'Werken jullie alleen in de regio Costa del Sol?',
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                answer: 'Niet elke auto komt in aanmerking. De voorwaarden zijn: de auto heeft op of na 16 oktober 2006 een Nederlands kenteken gekregen, het is geen schadevoertuig, u meldt de auto af met de RDW-status "Export" en de Spaanse registratie vindt plaats binnen 13 weken na de exportmelding. Auto\'s van vóór 2006 of met schadestatus zijn uitgesloten.',
            },
            {
                question: 'Hoe hoog is de BPM-teruggave?',
            ...
            },
            {
                ...
                answer: 'Ja. Bij ons Compleet- en Compleet Plus-pakket verzorgen wij de volledige BPM-teruggaveprocedure, inclusief het indienen van het formulier bij de Belastingdienst en het aanleveren van de benodigde documenten. U hoeft hier zelf niets voor te doen.',
            },
        ],
    },
    {
        ...
        items: [
            {
                question: 'Wat is de ITV?',
                answer: 'De ITV (Inspección Técnica de Vehículos) is de Spaanse equivalent van de Nederlandse APK. De auto wordt gekeurd op technische staat, uitstoot en veiligheid. Zonder een goedgekeurde ITV kunt u de auto niet op een Spaans kenteken registreren.',
            },
            {
                question: 'Wat wordt er bij de ITV gecontroleerd?',
                answer: 'De ITV controleert onder meer de remmen, verlichting, stuurinrichting, uitlaatgassen, banden, carrosserie en elektrische installaties. De eisen zijn vergelijkbaar met de Nederlandse APK, maar er zijn kleine verschillen in meetmethodes en normen.',
            },
            {
                question: 'Wat als mijn auto de ITV niet haalt?',
            ...
            },
            {
                ...
                answer: 'In principe niet voor de Spaanse registratie, maar rijdt u ook door Frankrijk, dan is een koplampsticker verplicht om verblinding van tegenliggers te voorkomen. Voor de ITV zelf zijn de originele koplampen van een Europees voertuig doorgaans voldoende.',
            },
        ],
    },
    {
        title: 'Spaanse invoerbelasting (IEDMT)',
        items: [
            {
            ...
            },
            {
                ...
                answer: 'In sommige gevallen is vrijstelling of verlaging mogelijk, bijvoorbeeld voor grote gezinnen (familia numerosa) of mensen met een beperking. De voorwaarden hiervoor zijn strikt. Wij adviseren u of uw situatie in aanmerking komt.',
            },
        ],
    },
    {
        ...
        items: [
            ...
            {
                question: 'Wat is een NIE-nummer en heb ik dat nodig?',
    ...
    },
    {
        ...
        items: [
            ...
            {
                question: 'Wat is inbegrepen in het Basis-pakket?',
            ...
            },
            {
                ...
                answer: 'Nee. Wij werken altijd met een vaste serviceprijs vooraf. De officiële kosten (ITV, IEDMT, leges) zijn variabel en afhankelijk van uw auto, maar die maken wij inzichtelijk vóórdat u akkoord gaat. U betaalt nooit meer dan afgesproken.',
            },
            {
                question: 'Wanneer betaal ik de servicekosten?',
                answer: 'U betaalt de servicekosten bij de start van het traject. De officiële kosten zoals IEDMT en ITV-keuring worden apart en op het moment van betaling voldaan — u maakt die direct over aan de betreffende instantie, niet via ons.',
            },
        ],
    },
    {
        ...
        items: [
            ...
            {
                question: 'Hoe lang moet ik mijn nummerplaten bewaren?',
            ...
            {
                question: 'Wat als mijn auto later wordt verkocht in Spanje?',
...
<template>
    ...
    >
        ...
        <section class="border-t border-border bg-secondary/30">
            <div class="container mx-auto max-w-3xl px-4 py-14 md:py-20">
                <div
                ...
                <div class="mt-4 rounded-2xl border border-border bg-card p-8 text-center">
                    ...
                    <a
                        href="/contact"
                        class="mt-5 inline-flex items-center justify-center rounded-xl bg-accent px-6 py-3 text-sm font-semibold text-accent-foreground shadow-sm transition-colors hover:bg-accent/90"
                    >
                        Stel uw vraag
                    </a>
                </div>
